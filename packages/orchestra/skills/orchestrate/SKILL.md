...
description: |
  ...
  Trigger when the user says: "orchestrate", "orchestruj", "coordinate agents", "koordinuj agenty", "multi-agent", "split the work", "rozděl práci", "split into phases", "rozděl na fáze", "full pipeline", "plan + implementation + review", "plán + implementace + review".
