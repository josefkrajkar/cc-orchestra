...
CREATE TABLE nodes (
  ...
  canonical     TEXT NOT NULL,          -- canonical name of the entity
...
CREATE TABLE observations (
  ...
  superseded_by INTEGER REFERENCES observations(id),  -- newer fact that superseded this one
...
-- FTS5 full-text index over observations (BM25 relevance driver v1)
